...
def main():
    # load data
    with open('/Users/mako/PycharmProjects/ECS_170_Spring_2026_Project/data/stage_3_data/CIFAR', 'rb') as f:
        data = pickle.load(f)

    # method
    method_obj = Method_CNN_CIFAR('cnn_cifar', 'CNN for CIFAR-10')
    ...
    plt.title('CNN CIFAR-10 Training Convergence Curve')
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('./plots/stage3_cnn_cifar_convergence.png')
    plt.show()
