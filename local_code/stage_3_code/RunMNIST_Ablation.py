...
from local_code.stage_3_code.Method_CNN_MNIST_Ablation import Method_CNN_MNIST
...
def main():
    ...
    # method
    method_obj = Method_CNN_MNIST('cnn_mnist', 'CNN for mnist')
    ...
    plt.title('CNN MNIST Training Convergence Curve')
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('./plots/stage3_cnn_mnist_1_layer_convergence.png')
    plt.show()
